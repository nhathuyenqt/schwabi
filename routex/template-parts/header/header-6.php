...
?>
<header>
    <div id="header-sticky" class="header__area_6 header-4 header-5 white-bg">
    <?php if(!empty($header_topbar_switch)) : ?>
        <div class="header-4__top-bar header-5__top-bar">
            <div class="header-5__top-bar-bg-color"></div>
            <div class="container-fluid">
                <div class="header-4__top-bar-inner header-5__top-bar-inner">
                    <ul class="top-bar-list">
                        ...
                        <li><i class="fa-regular fa-envelope"></i><a href="mailto:<?php echo esc_attr( $header_email_url );?>"><?php echo esc_html( $header_email );?></a></li>
                    </ul>
                    <div class="top-social">
                        <div class="contact-link">
                            <?php routex_header_top_menu(); ?>
                        </div>
    ...
    <?php endif; ?>
        <div class="container-fluid">
            <div class="mega__menu-wrapper p-relative">
                <div class="header__main header-4__main  header-5__main">
                    <div class="header__left header-4__left header-5__left">
                        <div class="header__logo">
                        <?php routex_header_logo(); ?>
                        </div>
                        <div class="header__middle header-4__middle header-5__middle">
                    ...
                    <div class="header-4__wrap header-5__wrap">
                        <div class="header__right header-4__right header-5__right">
                            <div class="header__action header-5__action d-flex align-items-center">
                                <div class="header-2-icon d-none d-sm-inline-flex">
                                    <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_3984_62)">
                                        <path d="M31.8535 30.2461H42.8705" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M31.8535 35.3555H42.8705" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M31.8535 40.4648H42.8705" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.041 12.0547H23.058" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.041 17.1641H23.058" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.041 22.2773H17.5495" stroke="#034833" stroke-width="2.57908" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="header-5__btn-right-wrap">
                            <div class="header-4__icon header-5__icon dl-search-icon d-none d-sm-inline-flex">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.11173 15.2235C12.0394 15.2235 15.2235 12.0394 15.2235 8.11173C15.2235 4.18403 12.0394 1 8.11173 1C4.18403 1 1 4.18403 1 8.11173C1 12.0394 4.18403 15.2235 8.11173 15.2235Z" stroke="#034833" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M16.9998 16.9998L13.1328 13.1328" stroke="#034833" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>                                
                            </div>
                            <?php  if ( !empty( $header_top_button_text ) ): ?>
                            <a class="rr-btn" href="<?php echo esc_url( $header_top_button_link ); ?>"><?php echo esc_html( $header_top_button_text ); ?> <i class="fa-solid fa-arrow-right"></i></a>
                            <?php endif; ?>
                        </div>
