<?php
    ...
    $author_info = get_the_author_meta( 'routex_write_by');
    $facebook_url = get_the_author_meta( 'routex_facebook' );
    $twitter_url = get_the_author_meta( 'routex_twitter' );
    $linkedin_url = get_the_author_meta( 'routex_linkedin' );
    $instagram_url = get_the_author_meta( 'routex_instagram' );
    $routex_url = get_the_author_meta( 'routex_youtube' );
    $routex_write_by = get_the_author_meta( 'routex_write_by' );
