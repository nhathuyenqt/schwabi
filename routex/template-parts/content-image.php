...
<article id="post-<?php the_ID();?>" <?php post_class( 'blog-details__content format-image' );?>>
...
<?php else: ?>
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog__content mb-80 format-image mb-60' );?>>
    <?php if ( has_post_thumbnail() ): ?>
