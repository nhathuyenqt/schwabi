...
<ul class="blog-details__content-meta mt-20 d-flex wow fadeInLeft animated" data-wow-delay=".2s">
    ...
    <li><a href="<?php print esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) );?>"><svg width="11"
    ...
    <li><a href="<?php comments_link();?>"><svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
