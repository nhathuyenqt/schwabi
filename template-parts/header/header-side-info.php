<?php 
   ...
   */
    ...
    // Contacts Text 
    $header_side_contacts_text = get_theme_mod( 'header_side_contacts_text', __( 'CONTACT US', 'routex' ) );
        ...
        <div class="offcanvas__wrapper">
            <div class="offcanvas__content">
                ...
                <?php  if ( !empty( $header_side_contacts_text ) ): ?>
                    <h4 class="offcanvas__title mb-20"><?php echo esc_html( $header_side_contacts_text ); ?></h4>
                <?php endif; ?>
                <?php routex_header_side_info_social_profiles(); ?>
                </div>
            </div>
        </div>
    </div>
