        ...
        if ( $product ) {
            $defaults = array(
                ...
                'class'      => implode(
                    ...
                    array_filter(
                        array(
                            'tp-product-action-btn-2 tp-product-add-cart-btn cart-button icon-btn button product-action product-action-1 '.$stock_class.' '.$price_class,
...
function routex_sale_percentage(){
    global $product; 
    $output = '';
...
// routex_product_details
function routex_product_details(){
    global $product;
    global $post;
    global $woocommerce;
...
<div class="tp-shop-details__right-warp">
    ...
    <div class="tp-shop-details__price">
        ...
        <span class="red-color"><?php echo routex_sale_percentage(); ?></span>
    </div>
    <div class="tp-shop-details__text-2">
        <?php woocommerce_template_single_excerpt(); ?>
    </div>

    <div class="tp-shop-details__quantity-wrap mt-30 mb-30 d-flex align-items-center">
    ...
    <div class="tp-shop-details__social">
        <?php do_action( 'routex_woo_social_share' ); ?>
    </div>
</div>
<?php
}
add_action('woocommerce_single_product_summary', 'routex_product_details');



add_action( 'wp_footer' , 'routex_custom_quantity_fields_script' );

// custom_quantity_fields_script
function routex_custom_quantity_fields_script(){
    ?>
